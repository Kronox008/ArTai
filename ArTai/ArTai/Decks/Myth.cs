    ...
    class Myth
    {
        public static void SetDeckInfo()
        {
            if (Global.LanguageSelectedID == 0)
            {
                ...
                Global.DeckInfo = "Mythology gods, characters, quotes, cities, places, items, creatures.";
            ...
            else
            {
                ...
                Global.DeckInfo = "Mitologija: dievai, personažai, citatos, miestai, vietos, daiktai, butybės.";
